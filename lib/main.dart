...
import 'package:flutter_custompaint_and_animations_asshidev/loading_face_animation.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      title: 'Flutter Animation Car Demo',
      theme: ThemeData(primarySwatch: Colors.blue),
      home:
          // const MovingCar()
          const LoadingFaceAnimationScreen(),
    );
  }
}
...
class AnimationPracticeState extends State<AnimationPractice>
  ...
  late final Animation<Color?> animation2 =
      ColorTween(begin: Colors.white, end: Colors.green).animate(
          CurvedAnimation(
              parent: animationController2, curve: Curves.bounceInOut));
